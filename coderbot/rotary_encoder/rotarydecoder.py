...
class RotaryDecoder:
    ...
    """ Class to decode mechanical rotary encoder pulses.
        ...
        Uses quadrature decoding to determine both tick count and
        rotation direction from two phase-shifted encoder channels. """
    ...
    def __init__(self, pi, feedback_pin_A, feedback_pin_B, callback):
        ...
        self._callback = callback   # callback function: callback(direction, tick)
        ...
        # Uses full quadrature decoding (_pulse) for direction detection
    ...
    def _pulse(self, gpio, level, tick):
        ...
        self._lock.release()
        # Pass both direction and tick to the callback
        self._callback(direction, tick)
